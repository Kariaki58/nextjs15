...
const Left = () => {
  ...
  return (
    <aside>
      <Button className={`rounded-none lg:hidden absolute ${collapse ? 'left-60': ''}`} onClick={() => setCollapse((prev) => !prev)}>X</Button>
      <div className={`${bgClass} ${textClass} h-screen p-4 space-y-8 z-50 ${collapse ? 'fixed': 'hidden lg:fixed'}`}>
